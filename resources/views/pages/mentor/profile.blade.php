...
<div class="dashboard-container">
    ...
    <aside class="dash-sidebar">
        ...
        <a class="nav-item active" href="/pages/mentor/profile">
    ...
    <aside class="profile-sidebar">
        ...
        <div class="sidebar-badge" style="background:#d1fae5;color:#065f46;"><span class="material-icons" style="font-size: 18px; margin-right: 6px; display: inline-flex; vertical-align: middle;">person</span>Mentor</div>
    ...
    <main class="profile-main">
        ...
        <div class="profile-card">
            <div class="profile-card-header">
                <h3 style="display: flex; align-items: center; gap: 8px;"><span class="material-icons">assignment</span> Data Profil Mentor</h3>
